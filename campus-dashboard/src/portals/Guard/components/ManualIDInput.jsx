...
export default function ManualIDInput({ onSubmit, isLoading }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm shrink-0">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="bg-slate-800 hover:bg-slate-900 text-white font-black px-6 py-3 rounded-xl flex items-center gap-2 transition-colors disabled:opacity-50 shadow-sm active:scale-95"
        >
